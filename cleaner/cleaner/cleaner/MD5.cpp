...
//int md5file (const TCHAR *fn , unsigned long seed , MD5_CTX *mdContext)
//{
//	return md5file(CString(fn),seed,mdContext);
//}
//int md5file (CString fn, unsigned long seed, MD5_CTX *mdContext)
//{
//	HANDLE hFile;
//	int retval = -1;
//
...
//		for (;;)
//		{
//			ReadFile(hFile,buf, 1 * BLOCK_SIZE, &byteRead,0);			 
//			MD5Update(mdContext, (unsigned char *) buf, byteRead);
//			if (byteRead < BLOCK_SIZE) break;
//		}
//		CloseHandle(hFile);
//		MD5Final(mdContext);
//		retval = 0;
