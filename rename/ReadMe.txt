========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : rename
========================================================================


AppWizard has created this rename application for you.  This application
...
res\rename.ico
    ...
    icon is included by the main resource file rename.rc.
...
renameDlg.h, renameDlg.cpp - the dialog
    These files contain your CRenameDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in rename.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CRenameDlgAutoProxy class.  This class
